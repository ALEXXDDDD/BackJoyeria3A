...
public partial class DBZapatertiaDLopezContext : DbContext
{
    public DBZapatertiaDLopezContext()
    {
    }

    public DBZapatertiaDLopezContext(DbContextOptions<DBZapatertiaDLopezContext> options)
        : base(options)
    {
    }
